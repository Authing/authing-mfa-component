...
import { IMFATriggerData, IAuthingPublicConfig } from './src/types'

function Example() {
  const mfaTriggerData: IMFATriggerData = {
    "mfaToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..wiwgPvcKyGb5vRqntuPBCj8UMV2qBsPDO2sO2Gp3bv4",
    "nickname": '',
    "email": '',
    "phone": '',
    "phoneCountryCode": '',
  ...
  const publicConfig: IAuthingPublicConfig = {
    // @ts-ignore
    "allowedOrigins": [],
